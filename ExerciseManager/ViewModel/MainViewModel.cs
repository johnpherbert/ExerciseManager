...
namespace ExerciseManager.ViewModel
{
    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        {
            if (routine != null)
                routine.LiftingItems.Add(new LiftingItem() { Lift = new Lift("New Lift"), Reps = new Range(0), Sets = 0, Weight = new Weight(0), PushPullLift = "Push", TypeOfLift = "Power" });
        }
        ...
        {
            LiftingManager.Routines.Add(new LiftingRoutine() { Name = "New Routine" });
        }
    }
}